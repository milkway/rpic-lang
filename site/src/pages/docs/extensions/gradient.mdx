...
- `gradient` takes the fill slot (wins over `fill`/`shaded`); under
  [`hatch`](/docs/extensions/hatch) it becomes the pattern background;
  [`opacity`](/docs/extensions/opacity) applies to the result.
